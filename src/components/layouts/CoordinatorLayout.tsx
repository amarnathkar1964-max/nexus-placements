    ...
    <>
        ...
        {!collapsed && (
          <div className="mb-6 grid grid-cols-2 gap-2">
            ...
            <div className="p-3 rounded-lg bg-accent/10 border border-accent/30">
              <p className="text-2xl font-bold font-display text-accent">12</p>
      ...
      <div className="mt-auto border-t border-sidebar-border p-4">
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton asChild>
              <Link to="/coordinator/settings" className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-sidebar-accent transition-colors">
